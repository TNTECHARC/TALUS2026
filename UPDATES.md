...
*10 Feb:* Assembled hand (Strung thread through, glues thumb, inserted pins)
        ...
        ATTEMPTED at connect arduinos to neck + jaw servos (failure)
        Pins for bicep failed printing 3(?) times
        **PINS FOR FINGERS NEED TO BE SECURED -- PINS FOR BICEP NEED TO BE SECURED**
        Discovered speaker had not shipped yet- need shipping number
